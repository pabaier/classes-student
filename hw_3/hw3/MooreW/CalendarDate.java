...
public class CalendarDate {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof CalendarDate) {
            ...
            return day == other.day && mon == other.mon && 
                   year == other.year;
        } else {
            return false;
        }
    ...
    public String getDayOfWeek() {
        int day = 1;
        for (CalendarDate date = new CalendarDate(); !date.equals(this); day = (day + 1) % 7){
            date.nextDay();
        }
    ...
    public String toString() {
        return this.year + "/" + this.mon + "/" + this.day;  // fix to return correctly formatted date
    }
   private int getDaysInMonth(){
        int numDays = DAYS_PER_MONTH[this.mon];
        if (this.mon == 2 && this.isLeapYear() == true){
           ++numDays;
        }
        return numDays;
