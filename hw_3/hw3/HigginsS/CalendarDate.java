...
public class CalendarDate {
    ...
    public String getDayOfWeek() {
        int dayWeekI = 1;
        CalendarDate count = new CalendarDate(1753, 1, 1);
        while(!count.equals(this)){
            count.nextDay();
            dayWeekI = (dayWeekI + 1) % DAYS_PER_WEEK;
        }
        return DAY_NAMES[dayWeekI]; // right now, every day is Sunday
    }
    ...
    public boolean isLeapYear() {
        ...
        return leapYear;  // every year is leap year until you fix this
    }
