...
assignment_directory = root_directory + "hw_2\\" # will change
submission_directory = assignment_directory + "hw2\\" # will change
assignment_file_name = "MapDataDrawer.java" # will change - this is the file to run
