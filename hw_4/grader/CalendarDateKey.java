...
public class CalendarDateKey {
     ...
     */
    public CalendarDateKey(int year, int month, int day) {
       this.year = year;
       this.month = month;
       this.day = day;
    }
    ...
    /*
     * Returns whether the given object is a CalendarDateKey that refers to the 
     * same year/month/day as this CalendarDateKey.
     */ 
    public boolean equals(Object o) {
        // a well-behaved equals method returns false for null and non-Dates
        if (o instanceof CalendarDateKey) {
            CalendarDateKey other = (CalendarDateKey) o;
    ...
    public String getDayOfWeek() {
        int dayIndex = 1;
        CalendarDateKey temp = new CalendarDateKey(1753, JANUARY, 1);
