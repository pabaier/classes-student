...
public class CalendarDate {
    ...
    private static final String[] MONTH_NAME = {
        //   0,         1,          2,       3,       4,
        "null", "January", "Feburary", "March", "April",
        //  5,      6,      7,        8,           9,
    ...
    public boolean isAValidDate(){
        ...
        if (this.isLeapYear()){
            if (month > 0 && month < 13){
                if (DAYS_PER_MONTH[month] >= day && day > 0 && month != 2){
                    valid = true;
                }
                else if (29 >= day && day > 0 && month == 2){
                    valid = true;
                }
                else{
                    valid = false;
            ...
            if (month > 0 && month < 13){
                if (DAYS_PER_MONTH[month] >= day && day > 0 ){
                    valid = true;
                }
                else{
                    valid = false;
