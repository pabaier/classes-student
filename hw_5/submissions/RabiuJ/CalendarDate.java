 ...
 * CalendarDate for Ticket classes, added month-to-String conversion and daysUntil method
 * 
 * Jonathan Rabiu
 * 
 */ 
...
public class CalendarDate {
    ...
    public static void main (String[] args){
        CalendarDate test = new CalendarDate(2017, 5, 10);
        System.out.println(test.isAValidDate());
    }
}