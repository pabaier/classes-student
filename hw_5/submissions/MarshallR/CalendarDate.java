...
public class CalendarDate {
    ...
    private static final String[] MONTH_NAMES = { // these will be used by the get month method for the toString method
        "NotAMonth", "January", "Feburary", "March", "April","May", "June", "July", "August",
    ...
    public boolean isValidDate() {
        ...
        if((month > DECEMBER) || (day > getDaysInMonth())){
            isValid = false;
        }
