...
public class Solver {
    ...
    private class Node implements Comparable<Node>{
        ...
        public int compareTo(Node that) {
            ...
            // if (pri == 0){
            //     if (this.board.hamming() - that.board.hamming() == 0)
    ...
    public Solver(Board initial) {
        ...
        while (!pq.min().board.isGoal() && !pqB.min().board.isGoal()) {
            ...
            Iterable<Board> next = temp.board.neighbors(); 
            Iterable<Board> nextB = tempB.board.neighbors();
        ...
        solvable = fin.board.isGoal();

        while (fin.previous != null) {
            solution.push(fin.previous.board);
            fin = fin.previous;
        }
