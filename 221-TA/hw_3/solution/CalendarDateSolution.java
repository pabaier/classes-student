...
public class CalendarDateSolution {
     ...
     */
    public CalendarDateSolution(int year, int month, int day) {
       this.year = year;
       this.month = month;
       this.day = day;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof CalendarDateSolution) {
            CalendarDateSolution other = (CalendarDateSolution) o;
