...
public class CalendarDate {
    ...
    private static final String[] MONTH = {"0", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"};
    ...
    public boolean isAValidDate(){
        ...
        else if(this.month % 2 == 0 && this.month == 2 && (this.year % 400 == 0) || (this.year % 4 == 0 && this.year % 100 != 0)) {
    ...
    public int daysUntil(CalendarDate d) {
        int howMany = 0;
        CalendarDate when = new CalendarDate(year, month, day); // copy this int howMany = 0;
        while (!when.equals(d)) {
            howMany++;
            when.nextDay(); 
        }
